--// SETTINGS (REPLACE THIS)
local WEBHOOK_URL = "https://discord.com/api/webhooks/1484608665653739601/caQ5kZusc46Uq4dZLjD7OXmDrI2rXDjAO9Jl6-yt7m8xLTxAjC9uVqXdKRNRruXom9hh"

--// SERVICES
local HttpService = game:GetService("HttpService")
local player = game.Players.LocalPlayer

--// EXECUTOR DETECTION (basic)
...
--// REQUEST (supports multiple executors)
